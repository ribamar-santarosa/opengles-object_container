...
/* altough textures are not used in this example, some symbols about textures
 are defined. that's for showing the object_container API texture usage, but
 providing empty/NULL texture buffers */

#define TEXTURE_DIMENSION_NUMBER 2 /* 2-d texture */
...
int main(int argc, char **argv)
{
	...
	triangle  = object_new(3, &vertex_coords[0], &color_coords[0],
                        &texture_coordinates[0], texture_buffer_triangle, 0, 0);
